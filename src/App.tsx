...
export default function App() {
  ...
  const courseLessons = [
    ...
    { session: "Buổi 6", title: "Giải đề đọc hiểu - Đề số 1", date: "30/06/2026", status: "Đã mở", link: "https://youtu.be/4E86iRdl6Z4" },
    { session: "Buổi 7", title: "Giải đề đọc hiểu - Đề số 2", date: "01/07/2026", status: "Đã mở", link: "https://youtu.be/lAYeZXWGXME" },
    { session: "Buổi 8", title: "Giải đề đọc hiểu - Đề số 3", date: "02/07/2026", status: "Đã mở", link: "https://youtu.be/YolYUvaoDDs" },
    { session: "Buổi 9", title: "Nghị luận xã hội về một vấn đề hiện tượng, đời sống", date: "03/07/2026", status: "Đã mở", link: "https://youtu.be/H2p0gkfaUDk" },
    { session: "Buổi 10", title: "Nghị luận xã hội về tư tưởng, đạo lý", date: "04/07/2026", status: "Đã mở", link: "https://youtu.be/SlkFULdq_uI" },
    { session: "Buổi 11", title: "Nghị luận xã hội về một vấn đề trong TPVH, TPNT", date: "05/07/2026", status: "Đã mở", link: "https://youtu.be/hFlWvFjTBME" },
